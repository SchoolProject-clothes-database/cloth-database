...
public class UserDetailsController {
    ...
    @PostMapping()
    public ResponseEntity<UserDetailsEntity> createUserDetails(@RequestBody UserDetailsEntity userDetails) throws YoungerThan15Exception, InvalidEmailException {
